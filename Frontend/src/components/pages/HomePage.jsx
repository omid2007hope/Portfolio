...
function Home() {
  ...
  return (
    <section className="relative overflow-hidden px-6 pb-0 pt-8 text-white">
      <div className="mx-auto grid w-full max-w-7xl items-center gap-16 lg:grid-cols-[1.08fr_0.92fr]">
        <div className="order-2 space-y-8 lg:order-1 mt-0 md:mt-45 lg:mt-45 pb-20 md:pb-0 lg:pb-0">
